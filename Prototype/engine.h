...
public:
	...
	void simulate(const double seconds_to_simulate, const class Assets* assets, const Scene* scene, const Configuration* config, Input* input);

	GLFWwindow* window() const;

private:
	void simulate_AI(const double seconds_to_simulate, const Assets* assets, const Scene* scene, const Configuration* config, Input* input);
