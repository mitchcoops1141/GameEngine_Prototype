...
Colored_3D_Shader_Program::Colored_3D_Shader_Program(const Shader* vertex_shader, const Shader* fragment_shader)
	: Shader_Program("Shader_Program.3D.Colored", vertex_shader, fragment_shader)
{
}
...
void Colored_3D_Shader_Program::render(const Configuration* config, const Mesh* mesh, const std::vector<GLfloat>* colors, const glm::mat4* transformation) const
{
